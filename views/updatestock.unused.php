...
<input type="hidden" name="f" value="update_stock">
    <table>
        ...
        <tr>
            ...
            <td><input type="date" name="date" id="" value="<?php echo date('Y-m-d'); ?>" required></td>
            <td><input type="text" name="observation" placeholder="observation" id="" value="Ajuste" required></td>
        </tr>
        <tr><td colspan="4">
